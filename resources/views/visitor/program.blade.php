...
@section('content')
    ...
    <section class="py-20 bg-gradient-to-br from-primary-800 via-primary-900 to-secondary-900 text-white relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-10 right-10 w-64 h-64 bg-secondary-400 rounded-full blur-3xl"></div>
        </div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Dampak Kami</h2>
                <p class="text-gray-300 max-w-2xl mx-auto">Capaian program YALI Papua dalam angka.</p>
            </div>
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                    <i class="fa-solid fa-tree text-4xl text-primary-300 mb-4"></i>
                    <div class="text-4xl font-extrabold mb-1">500rb+</div>
                    <div class="text-sm text-gray-300">Hektar Hutan Terlindungi</div>
                </div>
                <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                    <i class="fa-solid fa-seedling text-4xl text-secondary-300 mb-4"></i>
                    <div class="text-4xl font-extrabold mb-1">50rb+</div>
                    <div class="text-sm text-gray-300">Bibit Ditanam</div>
                </div>
                <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                    <i class="fa-solid fa-users text-4xl text-primary-300 mb-4"></i>
                    <div class="text-4xl font-extrabold mb-1">5.000+</div>
                    <div class="text-sm text-gray-300">Masyarakat Terdampingi</div>
                </div>
                <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                    <i class="fa-solid fa-school text-4xl text-secondary-300 mb-4"></i>
                    <div class="text-4xl font-extrabold mb-1">100+</div>
                    <div class="text-sm text-gray-300">Workshop & Pelatihan</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50 text-center">
        <div class="max-w-3xl mx-auto px-4">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-4">Ingin Terlibat?</h2>
            <p class="text-gray-500 mb-8">Dukung program kami melalui donasi, kemitraan, atau bergabung sebagai relawan.</p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('donasi') }}" class="px-8 py-3.5 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 transition shadow-md">
                    <i class="fa-solid fa-heart mr-2"></i>Donasi
                </a>
                <a href="{{ route('mitra') }}" class="px-8 py-3.5 border-2 border-primary-600 text-primary-600 font-bold rounded-full hover:bg-primary-600 hover:text-white transition">
                    <i class="fa-solid fa-handshake mr-2"></i>Bermitra
                </a>
            </div>
        </div>
    </section>
