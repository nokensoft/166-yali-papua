<nav class="bg-white shadow-md sticky top-0 z-50" x-data="{ mobileMenu: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                <a href="{{ route('berita') }}" class="px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('berita*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:text-primary-700 hover:bg-primary-50 transition' }}">Artikel</a>
                <a href="{{ route('galeri') }}" class="px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('galeri*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:text-primary-700 hover:bg-primary-50 transition' }}">Galeri</a>
    ...
    <div x-show="mobileMenu" x-cloak x-transition class="lg:hidden bg-white border-t shadow-lg">
        <div class="px-4 py-4 space-y-1">
            ...
            <a @click="mobileMenu=false" href="{{ route('berita') }}" class="block px-3 py-2.5 rounded-md font-medium {{ request()->routeIs('berita*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:bg-primary-50 hover:text-primary-700' }}">Artikel</a>
            <a @click="mobileMenu=false" href="{{ route('galeri') }}" class="block px-3 py-2.5 rounded-md font-medium {{ request()->routeIs('galeri*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:bg-primary-50 hover:text-primary-700' }}">Galeri</a>
